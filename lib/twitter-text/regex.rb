...
module Twitter
  ...
  class Regex
    ...
    REGEXEN[:valid_gTLD] = %r{
      (?:
        (?:
          academy|actor|aero|agency|archi|arpa|asia|axa|bar|bargains|berlin|best|bid|bike|biz|black|blue|boutique|build|
          builders|buzz|cab|camera|camp|cards|careers|cat|catering|center|ceo|cheap|christmas|cleaning|clothing|club|
          codes|coffee|cologne|com|community|company|computer|construction|contractors|cooking|cool|coop|country|
          cruises|dance|dating|democrat|diamonds|directory|domains|edu|education|email|enterprises|equipment|estate|
          events|expert|exposed|farm|fish|fishing|flights|florist|foundation|futbol|gallery|gift|glass|gov|graphics|
          guitars|guru|haus|holdings|holiday|horse|house|immobilien|industries|info|institute|int|international|jetzt|
          jobs|kaufen|kim|kitchen|kiwi|koeln|kred|land|lighting|limo|link|london|luxury|management|mango|marketing|meet|
          menu|miami|mil|mobi|moda|moe|monash|museum|nagoya|name|net|neustar|ninja|nyc|okinawa|onl|org|partners|parts|
          photo|photography|photos|pics|pink|plumbing|post|pro|productions|properties|pub|qpon|recipes|red|ren|rentals|
          repair|report|rest|reviews|rich|rodeo|ruhr|ryukyu|saarland|sexy|shiksha|shoes|singles|social|sohu|solar|
          solutions|supplies|supply|support|systems|tattoo|technology|tel|tienda|tips|today|tokyo|tools|trade|training|
          travel|uno|vacations|vegas|ventures|viajes|villas|vision|vodka|vote|voting|voto|voyage|wang|watch|webcam|wed|
          wien|wiki|works|xxx|xyz|yokohama|zone|дети|онлайн|орг|сайт|بازار|شبكة|संगठन|みんな|世界|中信|中文网|公司|公益|商城|在线|我爱你|政务|
          机构|游戏|移动|组织机构|网络|集团|삼성
        )
      (?=[^0-9a-z@]|$))
    }ix
    ...
    REGEXEN[:valid_ccTLD] = %r{
      (?:
        (?:
          ...
          za|zm|zw|мон|рф|срб|укр|қаз|الاردن|الجزائر|السعودية|المغرب|امارات|ایران|بھارت|تونس|سودان|سورية|عمان|فلسطين|
          قطر|مصر|مليسيا|پاکستان|भारत|বাংলা|ভারত|ਭਾਰਤ|ભારત|இந்தியா|இலங்கை|சிங்கப்பூர்|భారత్|ලංකා|ไทย|გე|中国|中國|台湾|台灣|新加坡|
          香港|한국
        )
      (?=[^0-9a-z@]|$))
    }ix
